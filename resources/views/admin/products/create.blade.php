                ...
                <div class="card-body">
                    ...
                    <form action=" {{ url('admin/products') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="seo-tag-tab" data-bs-toggle="tab" data-bs-target="#seo-tag-tab-pane" type="button" role="tab" aria-controls="seo-tag-tab-pane" aria-selected="false">SEO Tags</button>
                            </li>
                            <li class="nav-item" role="presentation">
                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade border p-3" id="seo-tag-tab-pane" role="tabpanel" aria-labelledby="seo-tag-tab" tabindex="0">
                                <div class="mb-3">
